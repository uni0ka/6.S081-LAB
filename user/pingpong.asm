...
int main(int argc, char **argv){
  ...
  12:	3ae080e7          	jalr	942(ra) # 3bc <pipe>
	pipe(chi_to_par);
  16:	fd040513          	addi	a0,s0,-48
  1a:	00000097          	auipc	ra,0x0
  1e:	3a2080e7          	jalr	930(ra) # 3bc <pipe>
	char buf[100];

	int pid = fork();
  22:	00000097          	auipc	ra,0x0
  26:	382080e7          	jalr	898(ra) # 3a4 <fork>
    if(pid == 0){   //child
  2a:	e149                	bnez	a0,ac <main+0xac>
		close(par_to_chi[1]);
  2c:	fdc42503          	lw	a0,-36(s0)
  30:	00000097          	auipc	ra,0x0
  34:	3a4080e7          	jalr	932(ra) # 3d4 <close>
		close(chi_to_par[0]);
  38:	fd042503          	lw	a0,-48(s0)
  3c:	00000097          	auipc	ra,0x0
  40:	398080e7          	jalr	920(ra) # 3d4 <close>
		write(chi_to_par[1], "ping\n", strlen("ping\n"));
  44:	fd442483          	lw	s1,-44(s0)
  48:	00001517          	auipc	a0,0x1
  4c:	88050513          	addi	a0,a0,-1920 # 8c8 <malloc+0xe6>
  50:	00000097          	auipc	ra,0x0
  54:	12e080e7          	jalr	302(ra) # 17e <strlen>
  58:	0005061b          	sext.w	a2,a0
  5c:	00001597          	auipc	a1,0x1
  60:	86c58593          	addi	a1,a1,-1940 # 8c8 <malloc+0xe6>
  64:	8526                	mv	a0,s1
  66:	00000097          	auipc	ra,0x0
  6a:	366080e7          	jalr	870(ra) # 3cc <write>
		read(par_to_chi[0], buf, sizeof(buf));
  6e:	06400613          	li	a2,100
  72:	f6840593          	addi	a1,s0,-152
  76:	fd842503          	lw	a0,-40(s0)
  7a:	00000097          	auipc	ra,0x0
  7e:	34a080e7          	jalr	842(ra) # 3c4 <read>
	    fprintf(1, "%d: received %s", getpid(), buf);
  82:	00000097          	auipc	ra,0x0
  86:	3aa080e7          	jalr	938(ra) # 42c <getpid>
  8a:	862a                	mv	a2,a0
  8c:	f6840693          	addi	a3,s0,-152
  90:	00001597          	auipc	a1,0x1
  94:	84058593          	addi	a1,a1,-1984 # 8d0 <malloc+0xee>
  98:	4505                	li	a0,1
  9a:	00000097          	auipc	ra,0x0
  9e:	65c080e7          	jalr	1628(ra) # 6f6 <fprintf>
		exit(0);
  a2:	4501                	li	a0,0
  a4:	00000097          	auipc	ra,0x0
  a8:	308080e7          	jalr	776(ra) # 3ac <exit>
	}
	else{   //parent
		close(par_to_chi[0]);
  ac:	fd842503          	lw	a0,-40(s0)
  b0:	00000097          	auipc	ra,0x0
  b4:	324080e7          	jalr	804(ra) # 3d4 <close>
		close(chi_to_par[1]);
  b8:	fd442503          	lw	a0,-44(s0)
  bc:	00000097          	auipc	ra,0x0
  c0:	318080e7          	jalr	792(ra) # 3d4 <close>
		read(chi_to_par[0], buf, sizeof(buf));
  c4:	06400613          	li	a2,100
  c8:	f6840593          	addi	a1,s0,-152
  cc:	fd042503          	lw	a0,-48(s0)
  d0:	00000097          	auipc	ra,0x0
  d4:	2f4080e7          	jalr	756(ra) # 3c4 <read>
	    fprintf(1, "%d: received %s", getpid(), buf);
  d8:	00000097          	auipc	ra,0x0
  dc:	354080e7          	jalr	852(ra) # 42c <getpid>
  e0:	862a                	mv	a2,a0
  e2:	f6840693          	addi	a3,s0,-152
  e6:	00000597          	auipc	a1,0x0
  ea:	7ea58593          	addi	a1,a1,2026 # 8d0 <malloc+0xee>
  ee:	4505                	li	a0,1
  f0:	00000097          	auipc	ra,0x0
  f4:	606080e7          	jalr	1542(ra) # 6f6 <fprintf>
		write(par_to_chi[1], "pong\n", strlen("pong\n"));  //在打印完ping后再向child传pong，避免两个string交替打印造成结果错误
  f8:	fdc42483          	lw	s1,-36(s0)
  fc:	00000517          	auipc	a0,0x0
 100:	7e450513          	addi	a0,a0,2020 # 8e0 <malloc+0xfe>
 104:	00000097          	auipc	ra,0x0
 108:	07a080e7          	jalr	122(ra) # 17e <strlen>
 10c:	0005061b          	sext.w	a2,a0
 110:	00000597          	auipc	a1,0x0
 114:	7d058593          	addi	a1,a1,2000 # 8e0 <malloc+0xfe>
 118:	8526                	mv	a0,s1
 11a:	00000097          	auipc	ra,0x0
 11e:	2b2080e7          	jalr	690(ra) # 3cc <write>
		wait(0);
 122:	4501                	li	a0,0
 124:	00000097          	auipc	ra,0x0
 128:	290080e7          	jalr	656(ra) # 3b4 <wait>
	}
	exit(0);
 12c:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 494:	46050513          	addi	a0,a0,1120 # 8f0 <digits>
 498:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 560:	394b8b93          	addi	s7,s7,916 # 8f0 <digits>
 ...
 6a0:	24c90913          	addi	s2,s2,588 # 8e8 <malloc+0x106>
        while(*s != 0){
...
free(void *ap)
{
 ...
 768:	1a47b783          	ld	a5,420(a5) # 908 <freep>
 ...
 796:	00e6ea63          	bltu	a3,a4,7aa <free+0x50>
{
 ...
 7d8:	12f73a23          	sd	a5,308(a4) # 908 <freep>
}
 7dc:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 80a:	10253503          	ld	a0,258(a0) # 908 <freep>
 ...
 832:	0da90913          	addi	s2,s2,218 # 908 <freep>
  if(p == (char*)-1)
 836:	5afd                	li	s5,-1
 838:	a88d                	j	8aa <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 83a:	00000797          	auipc	a5,0x0
 83e:	0d678793          	addi	a5,a5,214 # 910 <base>
 842:	00000717          	auipc	a4,0x0
 846:	0cf73323          	sd	a5,198(a4) # 908 <freep>
 84a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 86c:	0aa73023          	sd	a0,160(a4) # 908 <freep>
      return (void*)(p + 1);
